(function () {
  ...
  var publicResourceTemplateJsPath =
    "static_res/html5_templates/js/";
  var publicResourceJsPath =
    "static_res/js/";
  var publicResourceTemplateCssPath =
    "static_res/html5_templates/css/";
  var templateSourcePath =
    "static_res/html5_templates/template/Popular/";
  var yzReaderTemplatePath =
    "static_res/yzReader/templates/Slide/";
  ...
  function loadTemplate() {
    ...
    dynamicLoading.load(
      ...
      function () {
        // КИОСК: мобильный шаблон отключён — всегда версия для ПК.
        // Иначе на Android-экране через пару секунд поверх подгружался
        // main.phone.min.js и вёрстка «съезжала».
        // Вернуть автовыбор: раскомментировать условие ниже.
        // if (isPhone() || isPad()) {
        //   dynamicLoading.load([
